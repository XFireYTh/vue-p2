...
export default {
  ...
  beforeCreate() {},
  beforeMount() {
    ;(this.uuidGet(), (this.dadosAgente = this.infoGet()))
  },
  mounted() {},
}
</script>
...
<template>
  <div
    v-if="dadosAgente.abil"
    class="container d-flex justify-content-around align-items-center p-2"
  >
    <div class="row w-100 d-flex justify-content-around">
        ...
        <div class="w-100">
          <div class="row d-flex justify-content-center gap-3 mt-3">
            <button
              type="button"
              @click="icone = true"
              class="btn btn-outline-light border-0 col-4"
            >
              Icone
            </button>
            <button
          ...
          <div class="row d-flex justify-content-center align-items-center p-3">
            <img
              v-if="icone"
              :src="dadosAgente.icon"
              :style="{
                backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(255, 255, 255, 0.5)), url(${dadosAgente.back})`,
      ...
      <div class="col-lg-7 col-md-12 p-0 row bg-dark rounded">
        <div
          class="col-lg-2 row-md d-flex flex-md-column justify-content-center align-items-center gap-2 p-2"
        >
          <img
