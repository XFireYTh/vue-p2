  ...
  data() {
    return {
      cards: [
        ...
        {titulo: "Mapas", desc: "Descubra os mapas e algumas de suas características", img: ''}
...
<template>
  <div class="card border rounded border-dark col-md-3 m-2" v-for="(card, index) in cards" :key="index" style="background-color: #151515;">
    ...
    <div class="card-img-top w-100 d-flex justify-content-center">
      <img :src="card.img" alt="img-card" class="card-img-top w-75">
    </div>
    <div class="card-body">
      <p class="card-text text-white mt-2">{{ card.desc }}</p>
